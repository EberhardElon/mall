<template>
  <div>
        ...
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expand" :class="{'open':limitNum==addressList.length}">
                more
                <i class="i-up-down">
    ...
    <modal :md-show="isShow" @close="closeModel">
      <p slot="message">
        你确认要删除这条地址吗？
      </p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="delAddressConfirm">确认</a>
        <a class="btn btn--m" href="javascript:;" @click="isShow=false">关闭</a>
      </div>
    </modal>
          ...
          if(res.data.status=='0'){
            ...
            res.data.result.forEach((item,index,array)=>{
              ...
              if(item.isDefault){
                ...
                if(index>this.limitNum-1){
                  this.limitNum=array.length;
                }
              }
            });
          }
